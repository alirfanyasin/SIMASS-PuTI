<nav
  ...
  <div class="grid grid-cols-5 gap-1 px-2 py-2 safe-area">
    <a href="{{ route('app.dashboard') }}"
      class="mobile-nav-item {{ request()->routeIs('app.dashboard') ? 'active' : '' }} flex flex-col items-center gap-1 py-1.5 transition">
    ...
    <a href="{{ route('app.presence') }}"
      class="mobile-nav-item {{ request()->routeIs('app.presence') ? 'active' : '' }} flex flex-col items-center gap-1 py-1.5 transition">
      <div class="nav-icon-wrap w-9 h-9 rounded-xl flex items-center justify-center transition">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
    ...
    <a href="{{ route('app.presence-list') }}"
      class="mobile-nav-item {{ request()->routeIs('app.presence-list') ? 'active' : '' }} flex flex-col items-center gap-1 py-1.5 transition">
      <div class="nav-icon-wrap w-9 h-9 rounded-xl flex items-center justify-center transition">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
    ...
    <a href="{{ route('app.overtime') }}"
      class="mobile-nav-item {{ request()->routeIs('app.overtime') ? 'active' : '' }} flex flex-col items-center gap-1 py-1.5 transition">
      <div class="nav-icon-wrap w-9 h-9 rounded-xl flex items-center justify-center transition">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
    ...
    <a href="{{ route('app.presence-history') }}"
      class="mobile-nav-item {{ request()->routeIs('app.presence-history') ? 'active' : '' }} flex flex-col items-center gap-1 py-1.5 transition">
      <div class="nav-icon-wrap w-9 h-9 rounded-xl flex items-center justify-center transition">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
          <path d="M3 3v5h5" />
