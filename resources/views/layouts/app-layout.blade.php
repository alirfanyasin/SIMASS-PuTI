...
<head>
  ...
  <title>{!! html_entity_decode(strip_tags(trim($__env->yieldContent('title', 'Presensi')))) !!} — Portal PuTI</title>
  ...
  <script>
    (function() {
      ...
      document.addEventListener('keydown', e => {
        ...
        if (e.key === 'F12' || ((e.ctrlKey || e.metaKey) && (e.shiftKey && block.includes(e.key
            .toUpperCase()) || block.includes(e.key.toUpperCase())))) {
          e.preventDefault();
          return false;
        }
      });
